...
export function TaskCard({
  ...
  return (
    <div className={`task-card bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 border border-gray-200 dark:border-gray-700 ${className}`}>
      {/* Header */}
      <div className="p-4">
          ...
          <div className="flex items-start space-x-3 flex-1">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
                <span>{typeLabels[task.type as keyof typeof typeLabels] || task.type}</span>
          ...
          {task.logs && task.logs.length > 0 && (
            <div className="p-4">
              ...
              <div className="text-xs font-mono space-y-1">
                {task.logs.slice(-5).reverse().map((log) => (
                  <div key={log.id} className="text-gray-600 dark:text-gray-400">
