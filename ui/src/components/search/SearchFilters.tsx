...
const categoryOptions: { value: PaperCategory; label: string; color: string }[] = [
  { value: 'llm-agents', label: 'LLM Agents', color: 'blue' },
  { value: 'context-engineering', label: 'Context Engineering', color: 'green' },
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  <div className={`font-medium ${isSelected ? getColorClasses(option.color, 'text') : 'text-gray-700 dark:text-gray-300'}`}>
                    {option.label}
                  </div>
                </div>
              </label>
              ...
              return option ? (
                <span
                  ...
                  className={`
                    ...
                    ${getColorClasses(option.color, 'bg')} ${getColorClasses(option.color, 'text')}
                  `}
                >
                  {option.label}
                  <button
